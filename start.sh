...
# Create a desktop entry for Virt-Manager
RUN echo '[Desktop Entry]\n' \
    'Version=1.0\n' \
    'Name=Virt-Manager\n' \
    ...
    > /home/Paco/Desktop/virt-manager.desktop && \
    chmod +x /home/Paco/Desktop/virt-manager.desktop && \
    chown Paco:Paco /home/Paco/Desktop/virt-manager.desktop
